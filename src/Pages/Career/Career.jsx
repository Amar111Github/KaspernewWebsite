...
const Career = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setStatus("Sending...");
    const { firstname, lastname, email, mobile, gender, position, resume } = e.target.elements;
    ...
    if (response.ok) {
      ...
      firstname.value = "";
      lastname.value = ""; email.value = "";mobile.value = ""; gender.value = "";position.value = ""; resume.value = "";
    } else {
      ...
      <div>
        <div className="career-application">
          ...
          <div className="container pt-5 pb-5">
            <div className="highlights-text text-center">
              <ServiceMainSection highlights="INTERNSHIP OPENINGS" highlightsDouble="INTERNSHIP" />
            </div>
            <ul className="Internship-list">
              <li>
                <h4 href="#">Frontend Developer</h4>
                <input
              ...
              <li>
                <h4 href="#">Full-Stack Developer</h4>
                <input
                  className="btn btn-pointer"
                  type="button"
                  href
        ...
        <div className="career-registration" id="career-registration">
          <div className="d-flex flex-column justify-content-center aline-item-center text-center">
            <div className="highlights-text text-center">
              <ServiceMainSection highlights="APPLICATION PROCESS" highlightsDouble="APPLICATION" />
          ...
          <div className="row container m-auto" >
            <div style={{ position: 'relative' }} className="col-12 col-md-6 py-3 mb-5 mb-md-0">
              <iframe title="kasperMap" src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.0828742360973!2d77.36992837458807!3d28.62727818432098!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce5dbb8748335%3A0x3cfcbbd326e7a390!2sKasper%20Infotech%20Pvt%20Ltd!5e0!3m2!1sen!2sin!4v1696592982892!5m2!1sen!2sin' style={{ border: '0', width: '100%', height: '100%', boxShadow: '-3px 3px 5px rgba(230, 216, 216, 0.658)', borderRadius: '10px', border: '1px solid rgba(580, 216, 216, 1)', zIndex: '-1' }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
              <span style={{ position: 'absolute', width: '100%', height: '100%', background: "rgba(199, 189, 189, 0.267)", left: '0', top: "0", borderRadius: '10px' }}></span>
            </div>
            <div className="col-12 col-md-6">
              <div className="container d-flex justify-content-between">
                <form id="careerForm" encType="multipart/form-data" form onSubmit={handleSubmit}>
