...
const SportsAppDev = () => {
  ...
  return (
    <>
        <Helmet>
        <title>
        BEST SPORTS APP DEVELOPMENT COMPANY
        </title>
        <meta
          name="discription"
          content="Kasper provides the exceptional best sports apps for upgrading your sports industry and boosting your business globally."
        />
        <meta
          name="keywords"
          content="SPORTS APP DEVELOPMENT"
        />
      </Helmet>
      <IndistryHeaderComp
        HeaderImage={SportsAppimage}
        heading="BEST SPORTS APP DEVELOPMENT COMPANY"
