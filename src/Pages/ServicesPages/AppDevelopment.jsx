...
import {TwoPartGridLeft,TwoPartGridRight,} from "../../Components/SubComponents/ServiceComponents/ServiceSubComponents/TwoPartGrid";
    ...
    <>
      ...
      <div className="HideServiceList">
        <MainHeader
          ...
          subHeading="Looking for a seamless Mobile App Development Company? Worry, no more, and shake hands with us for unique mobile app development. Our experts mingle technologies and agile methodologies for assuring seamless mobile app development."
        />
        <ServiceMainSection
        ...
        <div className="row container m-auto">
          <TwoPartGridLeft
            title="UI/ UX Design"
            Discription="We follow strategies for developing unique mobile applications, upgrading your business level creating unique mobile app designs. Make your digital presence online through our Mobile App Development Company."
            ImageHandle={UIUXMOBILE}
          />
          <TwoPartGridRight
            title="iOS APP DEVELOPMENT"
            Discription="Make optimum utilization of programming languages like Swift and Objective-C, you remain updated with iOS development. Our professional mobile app developers frame the apps for Apple's iOS platform. Expand your business with iOS apps now."
            ImageHandle={IOS}
          />
          <TwoPartGridLeft
        ...
        <div className="row container m-auto">
          <TwoPartGridLeft
            ...
            Discription="Mobile App Development Company emphasizes transforming your idea into reality through a mobile app. In this competitive marketplace, we develop extraordinary mobile apps. We learn your innovative app ideas and create mobile android apps."
            ImageHandle={Idea}
          />
          <TwoPartGridRight
