  ...
  return (
    ...
    <Helmet>
      ...
      <div class="container mb-5">
          <div class="highlights-text text-center pb-4 pt-1 pb-1"><h2 class="text-uppercase">DIFFERENCE BETWEEN WEBSITES AND WEB APPS!! </h2></div>
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <hr />
                  <p class="card-text">A website consists of static information and cannot be changed easily.</p>
                  <hr />

                  <p>Websites are defined by their outputs, i.e., we read the news, marketing information, and FAQs on websites</p>
                  <hr />
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <hr />
                  <p class="card-text">Web Apps consist of dynamic information and can be changed easily..</p>
                  <hr />

                  <p>Web Apps are defined by their inputs, i.e., we develop, read, update, and delete data within a web application</p>
                  <hr />
      ...
      />
      <WhyUsComp
        whytext1="Select Kasper Infotech for the best Web Application Development. We deliver exceptional web app development services while keeping your business requirements in mind."
      ...
      <div className="row container m-auto">
        ...
        <TwoPartGridLeft
          ...
          Discription="With the right Custom web application development service provider, you can grab the golden opportunity of having amazing SEO Services. In this manner, you can make your business rank at the topmost over Google. This will not only increase your business sales but also create a high goodwill within the market."
