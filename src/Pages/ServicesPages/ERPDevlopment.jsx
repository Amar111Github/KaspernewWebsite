  ...
  return (
    <>
      ...
      <MainHeader
        ...
        mainheading="ERP Development for leveraging business expansion"
        subHeading="Within the digitalized era, organizations require accurate planning and real-time control of processes and resources to succeed within the competitive market. ERP Development is the solution to resolve your problems and take your business towards the next level."
      />
      <div className="servicesmainERP mt-4">
        ...
        <div className="row container m-auto">
          ...
          <TwoPartGridRight
            ...
            list2="Time Work flexibly: Employees perform smoothly & accomplish more tasks in less time.ERP System helps to rely on functions over repetitive work."
          ...
          <TwoPartGridRight
            ...
            list3="Customer Satisfaction: ERP leads towards upgrading customer satisfaction. Customer demands get fulfilled immediately, while queries are resolved instantly."
          ...
          <TwoPartGridLeft
            ...
            list1="Enhanced Training: With the help of the right skills, our team can use Custom ERP Software to provide practical Training, including workshops and training materials."
      ...
      <div className="prosessERP mt-5">
        ...
        <div className="row container m-auto HideServiceList">
          ...
          <TwoPartGridLeft
            ...
            Discription="One of the most necessary stages is scope definition, wherein we describe the objectives, vision, mission and limitations, opening the doorways for ERP Software."
            ImageHandle={scops}
          />
          <TwoPartGridRight
            title="DESIGN AND PLANNING"
            Discription="With an ERP, you can design and plan how you will operate your business effectively and efficiently. In this manner, you can boost your business functionality."
            ImageHandle={design}
          />
          <TwoPartGridLeft
