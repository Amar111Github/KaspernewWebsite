    ...
    <div>
      <section className="home-Testimonials py-5 mb-3 ">
        <ServiceMainSection
          ...
          heading="Our team is always ready and keen to explore the latest programming languages, frameworks, databases, and platforms. We stay updated with the industry’s requirements."
        />
