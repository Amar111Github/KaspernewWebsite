    ...
    >
      <Carousel.Item className="Carousel-Item"  >
        <div className="row container m-auto flex-column-reverse flex-md-row ">
          <div className="col-12  col-md-6 d-flex p-2 gap-2 flex-column aline-start justify-center">
            ...
            <Link style={{zIndex:'5'}} className="btn btn-warning fw-bold rounded-5" to="/Web-Development-Service">
              Know More →
            </Link>
            <Link style={{zIndex:'5'}} className="btn btn-success fw-bold rounded-5" to="/Contact-us">
             Contact Us  ◈
            </Link>
            </div>
          </div>
      ...
      <div className="row container m-auto ">
          <div className="col-12 col-md-6 d-flex p-2 gap-2 flex-column aline-start justify-center">
            ...
            <div className="d-flex ctabuttons gap-2 py-3">
            <Link style={{zIndex:'5'}} className="btn btn-warning fw-bold rounded-5" to="/ERP-Development-Service">
              Know More →
            </Link>
            <Link style={{zIndex:'5'}} className="btn btn-success fw-bold rounded-5" to="/Contact-us">
             Contact Us  ◈
      ...
      <div className="row container m-auto ">
          <div className="col-12  col-md-6 d-flex p-2 gap-2 flex-column aline-start justify-center">
            ...
            <h2 className="fs-4 text-md-start text-center">
              SEO | ASO | PPC | Content Management | Social Media Marketing & More
            </h2>
            <div className="d-flex ctabuttons gap-2 py-3 ">
            <Link style={{zIndex:'5'}} className="btn btn-warning fw-bold rounded-5" to="/Digital-Marketing-Service">
              Know More →
            </Link>
            <Link style={{zIndex:'5'}} className="btn btn-success fw-bold rounded-5" to="/Contact-us">
             Contact Us  ◈
          ...
          <div className="col-12 d-none d-md-flex banner-section col-md-6 p-2 gap-2 flex-column aline-start">
            ...
            <div className="blob2"></div>
            <div className="blob3 d-none d-md-block"></div>
            <img style={{borderRadius:'50% 0' }}   src={Banner3} alt="" />
            </div>
          </div>
        </div>
      ...
      <div className="row container m-auto ">
          <div className="col-12 col-md-6 d-flex p-2 gap-2 flex-column aline-start justify-center">
            ...
            <div className="d-flex ctabuttons gap-2 py-3">
            <Link style={{zIndex:'5'}} className="btn btn-warning fw-bold rounded-5" to="/CRM-Development-Service">
              Know More →
            </Link>
            <Link style={{zIndex:'5'}} className="btn btn-success fw-bold rounded-5" to="/Contact-us">
             Contact Us  ◈
